...
if visitors_match:
    ...
    for row in data:
        ...
        if match:
            ...
            if not (visiting5tuple in visitingDictionary):
                visitingDictionary[visiting5tuple] = TeamStats()
            visitingDictionary[visiting5tuple].points_missed += 2
        ...
        if match:
            ...
            if not (visiting5tuple in visitingDictionary):
                visitingDictionary[visiting5tuple] = TeamStats()
            visitingDictionary[visiting5tuple].points_missed += 1
        ...
        if match:
            ...
            if not (visiting5tuple in visitingDictionary):
                visitingDictionary[visiting5tuple] = TeamStats()
            visitingDictionary[visiting5tuple].points_missed += 3
...
#####AUTOMATED#####
    ...
    #POINTS AGAINST
        ...
        if match:
            ...
            if not (home5tuple in homeDictionary):
                homeDictionary[home5tuple] = TeamStats()
            homeDictionary[home5tuple].points_missed +=2
        ...
        if match:
            ...
            if not (home5tuple in homeDictionary):
                homeDictionary[home5tuple] = TeamStats()
            homeDictionary[home5tuple].points_missed += 1
        ...
        if match:
            ...
            if not (home5tuple in homeDictionary):
                homeDictionary[home5tuple] = TeamStats()
            homeDictionary[home5tuple].points_missed += 3
